...
def main():
    ...
    threads = []
    threads.append(Stock('sh','/media/gabriel/1041189C1041189C/new_tdx/vipdoc/sh/lday/','sh6'))
    threads.append(Stock('sz','/media/gabriel/1041189C1041189C/new_tdx/vipdoc/sz/lday/','sz'))
